  ...
  return (
    <div className="landing-container">
      ...
      <section className="hero-section">
        <p style={{ textTransform: 'uppercase', letterSpacing: '0.1em', fontSize: '0.85rem', color: '#666', marginBottom: '1rem', fontWeight: 'bold' }}>Sistema de gestión</p>
        ...
        <p className="hero-subtitle">
          Gestión de inventario + Punto de venta + Contabilidad<br/>y facturación electrónica ARCA. Todo en una sola plataforma.
        </p>
